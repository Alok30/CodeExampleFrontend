      ...
      case FETCH_ARTICLES_SUCCESS:
        ar = (
          <div className="conatiner container_body">
            <div>
              {this.props.articleList.articles.results
                .slice(1, 10)
                .map((articles) => {
                  return (
                    <div className="row mt-2">
                      <div className="col-md-4">
                        <img
                          className=" img_css_container"
                          src={articles.thumbnail_standard}
                          alt={articles.title}
                        />{" "}
                      </div>
          ...
          <div className="footer css_footer">
            <div className="row">
              <div className="col-md-4">
                <h6>About</h6>
                <p>
                  It is a great feeling. Be it the Boxing day, be it the any
                  other day, I always wanted to play Test cricket and I made my
                  debut against South Africa in January this year. I made my
                  (ODI) debut against Australia in 2016, so to play Test cricket
                  here was a big deal for me. I am really happy to contribute to
                  the team's success
                </p>
              </div>
              <div className="col-md-4">
              ...
              <div className="col-md-4">
                ...
                <div className="row">
                  <div className="col-md-7">Social Links</div>
